...
export const CLIENT_SETTINGS_STORAGE_KEY = "t4code:client-settings:v1";
export const SAVED_ENVIRONMENT_REGISTRY_STORAGE_KEY = "t4code:saved-environment-registry:v1";
